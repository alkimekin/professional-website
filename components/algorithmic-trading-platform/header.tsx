    ...
    <div className="flex flex-row w-full items-center justify-between xl:gap-10 2xl:gap-0">
      ...
      <div className="flex flex-col gap-10">
        <div className="flex flex-col w-[80%]">
          <div className="text-[64px] font-medium">Algorithmic Trading</div>

          <div className="flex flex-row items-center gap-4">
            <div className="text-[64px] font-medium">Platform</div>
            <a
        ...
        <div className="flex flex-col items-start gap-6 text-[32px] font-light">
          Machine Learning-Based Auto Trading Algorithms for Cryptocurrency
          Exchange Accounts
        </div>
